                ...
                <div class="box box-primary">
                    ...
                    <form method="POST" role="form" id="post_form">
                        ...
                        <div class="box-footer">
                            ...
                            <button type="button" onclick='location.href="<?=\library\Assets::uri('test/userPhotoAdd.php')?>"' class="btn btn-danger">リセット</button>
                        </div>
                    </form>
                    <?php else:?>
...
$('#btn_submit').click(function(){
    ...
    $.ajax({
        type:"POST",
        url:"<?=\library\Assets::uri('userPhotoAdd.php','test_api')?>",
        data:'params='+params,
        cache:false,
