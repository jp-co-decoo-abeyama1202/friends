                    ...
                    <form method="POST" role="form" id="post_form">
                        <div class="box-body">
                            ...
                            <div class="form-group" id="image">
                                ...
                                <img src='<?=$data['image'] ? $data['image'] : \library\Assets::uri('noimage.png','img')?>' style='width:200px;height:200px;border:1px solid black;'/>
                            </div>
                        </div>
                        <div class="box-footer">
                            <input type="hidden" name="user_id" id="user_id" value="<?=$userId?>"/>
                            <button type="button" id="btn_submit" class="btn btn-primary" <?=$data['image'] ? '' : 'disabled'?>>送信</button>
                        </div>
                    </form>
                    <?php else:?>
...
$('#btn_submit').click(function(){
    ...
    $.ajax({
        type:"POST",
        url:"<?=\library\Assets::uri('userImageDelete.php','test_api')?>",
        data:'params='+params,
        cache:false,
